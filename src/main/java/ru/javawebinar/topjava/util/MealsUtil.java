...
public class MealsUtil {
    ...
    public static List<MealWithExceed> getWithExceed(Collection<Meal> meals, int caloriesPerDay) {
        return getFilteredWithExceeded(new ArrayList<>(meals), LocalTime.MIN, LocalTime.MAX, caloriesPerDay);
    }
    ...
    private static List<MealWithExceed> getFilteredWithExceededInOnePass2(List<Meal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
